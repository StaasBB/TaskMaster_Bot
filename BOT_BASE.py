...
# Инициализация бота: получение токена из переменных окружения или использование значения по умолчанию
API_TOKEN = os.getenv('API_TOKEN') or "7702580740:AAGfshA1NysPpDi3FG8cHPLhxDEr-bQv4KA"
